...
void Delay1ms(unsigned long msec){
// write this function 
	// xung thach anh la 80MHz
	// -> thoi gian bat dau thuc hien vòng lap while(i > 0) cho den khi thuc hien xong se ton 15990*5*(1/80M)s = 1 ms
	// cau lenh i-- ton 1 chu ky
	// so sánh i voi 0 ton 1 chu ky
	// -> moi lan thuc hien 1 lan lap ton 5 chu ky
		unsigned long i; 
		while(msec > 0)
		{
			i = 15990;
